...
const Choosesection = () => {
  return (
    <div className="container mx-auto px-[160px] py-[70px] ">
      <div className="text-start mb-8 pb-12">
        <div className="relative">
          <h1 className="text-7xl pb-10 font-body font-normal">
            Why choose us
          </h1>
          <p className="text-[#79754E] text-xs font-normal text-end absolute top-[75px] left-[190px] font-roboto tracking-[0.6em]">
            OUR RESULTS SPEAKS TRUTH
          </p>
        </div>
        <p className="text-sm font-roboto font-normal text-[#242424] opacity-70">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-32">
        ...
        <div className="h-full min-h-80 bg-white rounded-lg p-4 border-[1px] border-[#939393] ">
          ...
          <img src={fifth} alt="Logo 1" className="h-24 mx-auto pb-4" />

          <h2 className="text-center text-base font-normal pb-2 font-body">
            Competitive prices
          </h2>
          <p className="text-center text-xs font-roboto text-[#242424]">
        ...
        <div className="h-full min-h-80 bg-white rounded-lg  p-4 border-[1px] border-[#939393] text-center ">
          ...
          <img src={six} alt="Logo 2" className="h-24 mx-auto pb-4" />
        ...
        <div className="h-full min-h-80 bg-white rounded-lg  p-4 border-[1px] border-[#939393] text-center">
          ...
          <img src={seventh} alt="third" className="h-24 mx-auto pb-4" />
          <h2 className="text-center text-base font-normal text-gray-800 pb-2 font-body">
