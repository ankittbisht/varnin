      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="relative">
          ...
          <img
            src={img1}
            alt="First Image"
            className="z-10 absolute h-[500px]"
          />

          {/* Second Image */}
          <h1 className="text-[90px] font-body font-normal z-20 absolute top-[250px] left-[310px] -rotate-90 w-[450px] text-[#000D4B54] opacity-30;
">
            About Us
          </h1>
          <img
            src={img2}
            alt="Second Image"
            className="z-0 absolute h-[500px] w-[255px] top-[100px] left-[345px]"
          />
        </div>

        {/* Second Column */}
        <div className="flex flex-col justify-start text-left w-[470px] gap-2">
          {/* Heading */}
          <h2 className="text-4xl font-body  font-normal  mb-2">
            Who we are
          </h2>
          {/* Short Intro */}
          <p className=" mb-4 font-roboto text-xs tracking-[0.5em] text-[#013A71]">ABOUT VARNIN DESIGN CONSULTANCY</p>
          {/* Long Description */}
